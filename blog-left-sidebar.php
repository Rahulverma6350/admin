                        ...
                        <div class="blog__wrapper blog__wrapper--sidebar">
                            <div class="row row-cols-xl-3 row-cols-lg-2 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n30">
                                <div class="col mb-30">
                                    <div class="blog__items">
                                        <div class="blog__thumbnail">
                                            <a class="blog__thumbnail--link display-block" href="blog-details.php"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog5.webp" alt="blog-img"></a>
                                        </div>
                                        <div class="blog__content">
                                            ...
                                            <h3 class="blog__content--title h4"><a href="blog-details.php">Top 10 Best Furniture Company
                                                History you Should Know</a></h3>
                                            <p class="blog__content--desc">Mum ut perspiciatis unde omnis iste
                                                natus error sit voluptatem…..</p>
                                            <a class="blog__content--btn primary__btn" href="blog-details.php">Read more </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col mb-30">
                                    <div class="blog__items">
                                        <div class="blog__thumbnail">
                                            <a class="blog__thumbnail--link display-block" href="blog-details.php"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog6.webp" alt="blog-img"></a>
                                        </div>
                                        <div class="blog__content">
                                            <ul class="blog__content--meta d-flex">
                                                <li class="blog__content--meta__text">
                                ...
                                <div class="col mb-30">
                                    <div class="blog__items">
                                        <div class="blog__thumbnail">
                                            <a class="blog__thumbnail--link display-block" href="blog-details.php"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog7.webp" alt="blog-img"></a>
                                        </div>
                                        <div class="blog__content">
                                            <ul class="blog__content--meta d-flex">
                                                <li class="blog__content--meta__text">
                                ...
                                <div class="col mb-30">
                                    <div class="blog__items">
                                        <div class="blog__thumbnail">
                                            <a class="blog__thumbnail--link display-block" href="blog-details.php"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog8.webp" alt="blog-img"></a>
                                        </div>
                                        <div class="blog__content">
                                            <ul class="blog__content--meta d-flex">
                                                <li class="blog__content--meta__text">
                                ...
                                <div class="col mb-30">
                                    <div class="blog__items">
                                        <div class="blog__thumbnail">
                                            <a class="blog__thumbnail--link display-block" href="blog-details.php"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog9.webp" alt="blog-img"></a>
                                        </div>
                                        <div class="blog__content">
                                            <ul class="blog__content--meta d-flex">
                                                <li class="blog__content--meta__text">
                                ...
                                <div class="col mb-30">
                                    <div class="blog__items">
                                        <div class="blog__thumbnail">
                                            <a class="blog__thumbnail--link display-block" href="blog-details.php"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog10.webp" alt="blog-img"></a>
                                        </div>
                                        <div class="blog__content">
                                            <ul class="blog__content--meta d-flex">
                                                <li class="blog__content--meta__text">
