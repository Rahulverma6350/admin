...
<main class="main__content_wrapper">
                                ...
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            ...
                                            <a class="slider__content--btn primary__btn" href="shop.php">Start to Buying</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row mb--n28">
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.php"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner1.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.php"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner2.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.php"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner3.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items mb-25">
                        <a class="banner__items--thumbnail position__relative" href="shop.php"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner4.webp" alt="banner-img">
                    ...
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.php"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner5.webp" alt="banner-img">
    ...
    <?php
    $sqlCat = "SELECT * FROM `product_categories` WHERE status = 1";
...
<section class="product__section section--padding pt-0">
  <div class="container-fluid">
    <div class="section__heading text-center mb-30">
      <h2 class="section__heading--maintitle">Latest Popular Items</h2>
    </div>

    <div class="tab_content">
      <div id="latest" class="tab_pane active show">
        <div class="product__section--inner">
          <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30" id="latest-products">
            <!-- AJAX se yaha products aayenge -->
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="product__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <!-- Category buttons, each with a category ID or name -->
            <ul class="product__tab--btn d-flex justify-content-center mb-50">
                <!-- Dynamic category buttons go here -->
                <?php while ($fetCat = mysqli_fetch_assoc($resCat)) { ?>
                    <li class="product__tab--btn__list category-btn"
                        data-category-id="<?php echo $fetCat['pc_id']; ?>"
                        data-category-name="<?php echo $fetCat['category']; ?>"
                        <?php if ($fetCat['pc_id'] == 1) echo 'class="active"'; ?>> <!-- Set the first category as active -->
                        <?php echo $fetCat['category']; ?>
                    </li>
                <?php } ?>
            </ul>
            ...
            <div class="tab_content">
                <div id="chair" class="tab_pane active show">
                    <div class="product__section--inner">
                        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30" id="products">

                            <!-- This is where products will appear based on selected category -->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="banner__section section--padding pt-0">
        <div class="container-fluid">
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                ...
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.php"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner6.webp" alt="banner-img">
            ...
            <div class="row">
                <div class="col-xl-8 col-12 product__col--width__8">
                    <div class="product__section--wrapper">
                        ...
                        <div class="product__section--inner">
                            <div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n25" id="fatalProducts">


                                <script>
                                    function loadProducts(fatal) {
                                        const target = fatal === 1 ? '#fatalProducts' : '#popularProducts';

                                        fetch('fetch_products2.php?fatal=' + fatal)
                                            .then(res => res.text())
                                            .then(data => {
                                    ...
                                    // Load both sections
                                    loadProducts(1); // Fatal products
                                    loadProducts(0); // Popular products
                                </script>
                                ...
                                <div class="col d-xl-none d-xxl-block mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="product-details.php">Fabric Chair</a></h3>
                                            ...
                                            <a class="product__cart--btn__style2 primary__btn" href="cart.php"> Add to cart </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
                    <div class="deals__banner--thumbnail">
                        <a class="deals__banner--thumbnail__link display-block position__relative" href="shop.php"><img class="deals__banner--thumbnail__img display-block" src="assets/img/banner/banner9.webp" alt="deals-thumbnail-img">
        ...
        <div class="container-fluid">
            <div class="banner__video--thumbnail position__relative">
                ...
                <div class="bideo__play">
                    <a class="bideo__play--icon glightbox" href="../../../115041822.php" data-gallery="video">
            ...
            <div class="row row-cols-xl-2 row-cols-1">
                <div class="col col-lg-order">
                    <div class="testimonial__banner--thumbnail">
                        <a class="display-block" href="shop.php"><img class="testimonial__banner--thumbnail__img display-block" src="assets/img/banner/banner10.webp" alt="banner-img"></a>
                    </div>
                </div>
                <div class="col">
    ...
    $resBlog = mysqli_query($conn, $sqlBlog);
    ?>
    ...
    <section class="blog__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <div class="blog__section--inner blog__swiper--activation swiper">
                <div class="swiper-wrapper">
                    <?php
                    while ($rowBlog = mysqli_fetch_assoc($resBlog)) {
                    ?>
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.php?cid=<?php echo $rowBlog['id']; ?>"><img class="blog__thumbnail--img display-block" style="height: 306px;object-fit: cover;" src="admin/img/<?php echo $rowBlog['img']; ?>" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    ...
                                    <h3 class="blog__content--title h4"><a href="blog-details.php?cid=<?php echo $rowBlog['id']; ?>"><?php echo $rowBlog['tittle']; ?></a></h3>
                                    <p class="blog__content--desc"><?php echo $rowBlog['discription']; ?></p>
                                    <a class="blog__content--btn primary__btn" href="blog-details.php?cid=<?php echo $rowBlog['id']; ?>">Read more </a>
                                </div>
                            </div>
                        </div>
                    <?php
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkF3TLBTT7/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram1.webp" alt="instagram-img">
                    ...
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkF60sBxhN/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram2.webp" alt="instagram-img">
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewbox="0 0 25.198 25.199">
                                        <defs>
                                            <radialgradient cx="0.133" cy="1.005" r="1.305" gradienttransform="translate(0)" gradientunits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21"></stop>
                    ...
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkF90ZB6HG/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram3.webp" alt="instagram-img">
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewbox="0 0 25.198 25.199">
                                        <defs>
                                            <radialgradient cx="0.133" cy="1.005" r="1.305" gradienttransform="translate(0)" gradientunits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21"></stop>
                    ...
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkGAe6BQeu/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram4.webp" alt="instagram-img">
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewbox="0 0 25.198 25.199">
                                        <defs>
                                            <radialgradient cx="0.133" cy="1.005" r="1.305" gradienttransform="translate(0)" gradientunits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21"></stop>
                    ...
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkGCWcBbv9/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram5.webp" alt="instagram-img">
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewbox="0 0 25.198 25.199">
                                        <defs>
                                            <radialgradient cx="0.133" cy="1.005" r="1.305" gradienttransform="translate(0)" gradientunits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21"></stop>
                    ...
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkGFDMhoid/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram6.webp" alt="instagram-img">
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewbox="0 0 25.198 25.199">
                                        <defs>
                                            <radialgradient cx="0.133" cy="1.005" r="1.305" gradienttransform="translate(0)" gradientunits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21"></stop>
                    ...
                    <div class="swiper-slide">
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank" href="../../../p/CZkGGnyh7jZ/index.htm"><img class="instagram__thumbnail--img display-block" src="assets/img/other/instagram7.webp" alt="instagram-img">
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewbox="0 0 25.198 25.199">
                                        <defs>
                                            <radialgradient cx="0.133" cy="1.005" r="1.305" gradienttransform="translate(0)" gradientunits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21"></stop>
...
<script>
    $(document).ready(function() {
        ...
        // Initially load the first category's products
        loadProducts(1); // Default category ID (could be dynamic)

        // When a category is clicked
        $(".category-btn").click(function() {

            console.log("click on select-btn");
        ...
        function loadProducts(categoryId) {
            $.ajax({
                url: "fetch_products.php", // The file that handles fetching products based on category
                type: "GET",
                data: {
                    category_id: categoryId
                }, // Send the selected category ID
                success: function(response) {
                    // Populate the products section with the response
...
<script>
    ...
    function loadLatestProducts() {
        $.ajax({
            url: "latest_products.php",
            type: "GET",
            success: function(response) {
                $("#latest-products").html(response);
            },
            error: function() {
                alert("New products load nahi ho paaye.");
            }
        });
    }
});
