                    ...
                    <div class="col">
                        <div class="breadcrumb__content">
                            ...
                            <ul class="breadcrumb__content--menu d-flex">
                                ...
                                <li class="breadcrumb_content--menu_items"><span class="text-white">Contact Us</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="contact__section section--padding">
            <div class="container">
                <div class="section__heading mb-40">
                    <h2 class="section_heading--maintitle contact_section--hrading mb-10">Get In Touch</h2>
                    <p class="contact_section--hrading_desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere voluptatibus delectus blanditiis rerum, explicabo <br> aspernatur magni nihil distinctio voluptatum quo sit quidem minima repellat sapiente.</p>
                </div>
                        ...
                        <div class="col-lg-5">
                            <div class="contact__info border-radius-10">
                                <div class="contact__info--items">
                                    <h3 class="contact_info--content_title text-white mb-15">Contact Us</h3>
                                    <div class="contact_info--items_inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact_info--content_desc text-white">Change the design through a range <br> <a href="tel:+01234-567890"><?php echo $conntactFeatch ['phone_no'] ?></a> </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    <h3 class="contact_info--content_title text-white mb-15">Email Address</h3>
                                    <div class="contact_info--items_inner d-flex">
                                        <div class="contact__info--icon">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact_info--content_desc text-white"> <a href="mailto:info@example.com"><?php echo $conntactFeatch ['email'] ?></a> </p> 
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    <h3 class="contact_info--content_title text-white mb-15">Office Location</h3>
                                    <div class="contact_info--items_inner d-flex">
                                        <div class="contact__info--icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31.57" height="31.13" viewbox="0 0 31.57 31.13">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact_info--content_desc text-white"><?php echo $conntactFeatch ['addr'] ?></p> 
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    <h3 class="contact_info--content_title text-white mb-15">Follow Us</h3>
                                    <ul class="contact__info--social d-flex">
                                        <li class="contact_info--social_list">
                                            <a class="contact_info--social_icon" target="_blank" href="../../../index.htm">
                                        ...
                                        <li class="contact_info--social_list">
                                            <a class="contact_info--social_icon" target="_blank" href="../../../index-1.htm">
                                        ...
                                        <li class="contact_info--social_list">
                                            <a class="contact_info--social_icon" target="_blank" href="../../../en/index.htm">
                                        ...
                                        <li class="contact_info--social_list">
                                            <a class="contact_info--social_icon" target="_blank" href="../../../index-4.htm">
