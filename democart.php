...
<?php include('header.php')?>
    ...
    <main class="main__content_wrapper">
       ...
       <div class="cart-item">
            <button class="cart__remove--btn removecartlist" data-product-id=<?php echo $row['p_id']; ?> aria-label="remove button"  type="button">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16px" height="16px">
                    <path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z"></path>
                                                        ...
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a href="product-details.php"><?php echo $row['product_name'] ?></a></h4>
...
<?php endif; ?>
                    ...
                    <div class="quantity__box">
                        <button class="decrease" data-id="<?php echo $row['p_id']; ?>">-</button>
                        <input type="number" class="quantity__number" value="<?php echo $row['quantity']; ?>" min="1">
                        <button class="increase" data-id="<?php echo $row['p_id']; ?>">+</button>
                    </div>
                </td>
                                                <td class="cart__table--body__list">
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === "deleted") {
                    ...
                    updateCartCount(response.cart_count); // Ensure cart count updates dynamically
                } else {
...
<script>
    ...
    var inputField = $(this).siblings(".quantity__number");
    var newQuantity = parseInt(inputField.val());
    newQuantity = $(this).hasClass("increase") ? newQuantity + 1 : newQuantity - 1;
