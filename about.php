...
$team_member = 'SELECT * FROM `aboutus_ourteam`';
$result = mysqli_query($conn, $team_member);
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block" src="admin/img/<?php echo $row['photo']; ?>" alt="team-thumb">
                                </div>
                                <div class="team__content ">
                                    <h3 class="team__content--title"><?php echo $row['name']; ?></h3>
                                    <span class="team__content--subtitle"><?php echo $row['profession']; ?></span>
                                    <ul class="team__social d-flex justify-content-center align-items-center">
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="../../../index.htm">
                                        ...
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="../../../index-1.htm">
                                        ...
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="../../../en/index.htm">
                                        ...
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="../../../index-4.htm">
